      ...
      splitChunks: {
        ...
        cacheGroups: {
          ...
          vendor: {
            ...
            /**
             * The following line moves modules to the vendor when they´re repeated in 80% of your
             * entrypoints. Feel free to modify this heuristic to your needs
             */
            minChunks: entryPointsCount * 0.8,
